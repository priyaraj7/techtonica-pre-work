...
console.log(exercise4(7, 7));
console.log(exercise4(7, 5));
console.log(exercise4("hi", "ho"));
console.log(exercise4("hi", "hi"));
console.log(exercise4("hi", 7));
console.log(exercise4(7, "7"));
...
answer5 = `If we take the example of 4 === "4", we get the answer differ because their typeof is different 4 is a number and "4" is a string`;
...
console.log(exercise6(4, 4, 7));
console.log(exercise6(4, 7, 7));
console.log(exercise6(7, 4, 7));
console.log(exercise6(4, 8, 9));
console.log(exercise6("a", "x", "u"));
console.log(exercise6("a", "a", "u"));
console.log(exercise6("u", "x", "u"));
...
console.log(exercise8(6, 8, 3, 10));

console.log(exercise8(7, 11, 3, 10));

console.log(exercise8(4, 5, 7, 10));
...
// It was easy
// I took some time to understand the excercise 8.
// After checking all my answer using console I was updated the excercise 9
